...
sys.path.append("../")
import rsapp.version as app_version
...
project = 'Metadata Publishing Tool'
copyright = '2017, DANS-KNAW'
author = 'hvdb'
...
htmlhelp_basename = 'rspub-guidoc'
...
latex_documents = [
    (master_doc, 'rspub-gui.tex', 'rspub-gui Documentation',
     'h', 'manual'),
]
...
man_pages = [
    (master_doc, 'rspub-gui', 'rspub-gui Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'rspub-gui', 'rspub-gui Documentation',
     author, 'rspub-gui', 'One line description of project.',
     'Miscellaneous'),
]
